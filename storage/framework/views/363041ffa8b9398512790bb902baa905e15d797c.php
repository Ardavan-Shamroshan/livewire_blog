<main class="main container">
    <div class="row my-4">
        <div id="articleRight" class="col-12 col-md-8 col-xl-9">
            <div class="p-2 bg-light rounded">
                <h1 class="text-center font_2 py-2"><?php echo e($article->h_title); ?></h1>
                <div class="image text-center">
                    <img src="<?php echo e(asset($article->image)); ?>" alt="توضیح تصویر">
                </div>
        ...
        <div id="articleLeft" class="col-12 col-md-4 col-xl-3 mt-3 mt-md-0">
            <div class="row bg-light px1 py-5 text-center justify-content-center d-flex rounded w-100 m-auto">
                ...
                <div class="col-12 mt-3 justify-content-center">
                    ...
                    <h6 class="text-center"><?php echo e($article->writer_name); ?></h6>

                    <small class="text-center d-block mt-3">تاریخ:</small>
                    <h6 class="text-center"><?php echo e($article->created_at->diffForHumans()); ?></h6>

                    <div class="col-12 justify-content-center text-center mt-3">
                        <span class="text-center">بازدید : <?php echo e($article->view_count); ?> </span>
                    </div>
    ...
    <div class="row justify-content-center align-items-center alert-secondary p-3">
        ...
        <div class="row p-3 justify-content-center text-right alert-light d-block mb-4 col-12">
            ...
            <a href="" class="bg-light text-dark rounded p-1">#<?php echo e($keyword); ?></a>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-12 row justify-content-center form-group">
            <a href="<?php echo e(route('auth.login')); ?>" class="bg-light text-primary rounded p-1">برای ثبت نظر وارد شوید</a>
        </div>
        <?php endif; ?>
        ...
        <div class="col-12 col-md-11 bg-white p-3">
            ...
            <div class="row my-2 d-block p-2 rounded shadow-sm border_1 col-11 m-auto shadow">
                <div class="row justify-content-lg-between w-100 m-auto">
                    ...
                    <span>
                        <i class="fas fa-trash text-danger cursor_pointer_text_shadow mx-2" wire:click="destroy(<?php echo e($comment); ?>)"></i>
                ...
                <div class=" w-100 pb-3">
                    <p class="text-justify"><?php echo e($comment->text); ?></p>
...
<?php /**PATH C:\Users\ARDAVAN\Desktop\live_blog\resources\views/livewire/article/article.blade.php ENDPATH**/ ?>